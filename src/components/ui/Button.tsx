...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-primary hover:bg-primary-light text-white shadow-md hover:shadow-glow',
    secondary: 'bg-secondary hover:bg-secondary-light text-white shadow-md hover:shadow-glow',
    accent: 'bg-accent hover:bg-accent-light text-white shadow-md hover:shadow-accent-glow',
